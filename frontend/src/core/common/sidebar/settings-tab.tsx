...
const SettingsTab = () => {
  ...
  const handleEnable2FA = async () => {
    try {
      ...
      // update state userMe
      const responseMe: ApiResponse<UserData> = await httpRequest.post(
          `/user/me?ts=${Date.now()}`,
          {
            headers: {
  ...
  const handleChangePassword = async () => {
    ...
    if (!confirmNewPassword) {
      setChangePasswordErrorMessage(
          'Confirm New Password not be empty !'
      );
      return;
    }
      ...
      <>
          ...
          >
            <div className="slimscroll">
              ...
              <div className="sidebar-body chat-body">
                ...
                {/* Add a link to the Timetable section */}
                <div className="content-wrapper">
                  <h5 className="sub-title">Quick Links</h5>
                  <div className="chat-file">
                    <div className="file-item">
                      <div
                          className="accordion accordion-flush chat-accordion"
        ...
        >
          {loadingQR2fa ? (
              ...
              <>
                <p>
                  You have successfully enabled 2FA login. Use the
                  Google Authenticator app to scan the code below and
                ...
                >
                  * This QR code will only be displayed once. Make
                  sure to scan it now.
                </p>
              </>
          )}
