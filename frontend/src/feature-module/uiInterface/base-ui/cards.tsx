      ...
      <div className="content">
        ...
        <div className="row">
          ...
          <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div className="card">
              <ImageWithBasePath
                src="assets/admin/img/img-02.jpg"
                className="card-img-top"
                alt="..."
              />
              <div className="card-body">
          ...
          <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div className="card">
              <ImageWithBasePath
                src="assets/admin/img/img-03.jpg"
                className="card-img-top"
                alt="..."
              />
              <div className="card-body">
            ...
            <div className="row row-cols-12">
              <div className="col">
                <div className="card">
                  <div className="card-body">
                    <ImageWithBasePath
                      src="assets/admin/img/img-04.jpg"
              ...
              <div className="col">
                <div className="card">
                  <div className="card-body">
                    <ImageWithBasePath
                      src="assets/admin/img/img-05.jpg"
                      className="card-img mb-3"
                      alt="..."
                    />
        ...
        <div className="row">
          ...
          <div className="col-xl-2">
            <div className="card">
              <div className="card-body">
                <ImageWithBasePath
                  src="assets/admin/img/img-3.jpg"
                  className="card-img mb-3"
                  alt="..."
                />
                <h6 className="card-title fw-semibold mb-3">
        ...
        <div className="row">
          ...
          <div className="col-xl-4">
            <div className="card overlay-card">
              <ImageWithBasePath
                src="assets/admin/img/img-4.jpg"
                className="card-img"
                alt="..."
              />
              <div className="card-img-overlay d-flex flex-column p-0">
              ...
              <div className="card-body">
                <div className="d-flex align-items-center w-100">
                  <div className="me-2">
                    <span className="avatar avatar-rounded">
                      <ImageWithBasePath
                        src="assets/admin/img/profiles/profile-11.jpg"
                        alt="img"
                      />
                    </span>
                  </div>
              ...
              <div className="col-xxl-7 col-xl-12">
                <div className="card">
                  ...
                  <div className="row g-0">
                    ...
                    <div className="col-md-4">
                      <ImageWithBasePath
                        src="assets/admin/img/img-5.jpg"
