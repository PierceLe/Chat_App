          ...
          <div className="row">
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  <ul
                    className="nav nav-tabs mb-3 border-bottom-0"
                    role="tablist"
                  >
                    <li className="nav-item">
                      <Link
                ...
                <div className="card-body">
                  ...
                  <div className="tab-content">
                    ...
                    >
                      ...
                      beginner&apos;s guide to mission trips. If you read one
                      article about cultural notes read this one. Why you
                    ...
                    >
                      ...
                      can help you predict the future. How to cheat at dog
                    ...
                    >
                      ...
                      chef uniforms. How not knowing food processors makes you a
                    ...
                    <div className="col-xl-9">
                      <div className="tab-content">
                        ...
                        >
                          ...
                          away with it. 17 problems with summer activities. How
                          to cheat at travel agents and get away with it. How
                          not knowing family trip ideas makes you a rookie. What
                        ...
                        >
                          ...
                          The complete beginner&apos;s guide to mission trips.
                        </div>
                        <div
                          className="tab-pane text-muted"
                        ...
                        >
                          ...
                          sick. The complete beginner&apos;s guide to cooking
                        ...
                        >
                          ...
                          mexican food. The evolution of chef uniforms.
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    >
                      <ul className="mb-0">
                        ...
                        <li>
                          How travel coupons make you a better lover. Why
                          cultural solutions are the new black. Why mom was
                          header about travel insurances. How family trip ideas
                          can help you predict the future.{" "}
                          <b>How carnival cruises make you a better lover</b>.
                          Why you&apos;ll never succeed at daily deals. 11 ways
                          cheapest flights can find you the love of your life.
                  ...
                  <div className="tab-content">
                    ...
                    <div className="tab-pane" id="accepted" role="tabpanel">
                      <div className="text-muted">
                        ...
                        search for <b>&apos;lorem ipsum&apos;</b> will uncover
                ...
                <div className="card-body px-sm-4 px-2">
                  ...
                  <div className="tab-content" id="tab-style-4">
                    ...
                    >
                      ...
                      don&apos;t look even slightly believable.{" "}
                      <b>If you are going</b> to use a passage of Lorem Ipsum,
                      ...
                      <div className="tab-content" id="v-pills-tabContent">
                          ...
                          <div className="d-sm-flex">
                            <div className="me-3">
                              <span className="avatar avatar-xxl">
                                <ImageWithBasePath
                                  src="assets/admin/img/profiles/profile-02.jpg"
                                  alt="img"
                                />
                              </span>
                            </div>
                        ...
                        >
                          <ul className="list-unstyled text-muted mb-0">
                            ...
                            <li className="mb-0">
                              How hotel deals can help you live a better life.{" "}
                              <b>How celebrity cruises</b> aren&apos;t as bad as
                              you think. How cultural solutions can help you
                              predict the future. How to cheat at dog friendly
                        ...
                        >
                          <ul className="mb-0">
                            <li className="mb-2">
                              ...
                              ideas can helpyou predict the future.{" "}
                              <b>
                        ...
                        >
                          <ul className="mb-0">
                            <li className="mb-2">
                              ...
                              translation by H. Rackham,How hotel deals can help
                ...
                <div className="card-body">
                  ...
                  <div className="tab-content">
                    ...
                    >
                      ...
                      <b>How celebrity cruises</b> aren&apos;t as bad as you
                      think. How cultural solutions can help you predict the
                      future. How to cheat at dog friendly hotels and get away
                      with it.
                    </div>
                    <div
                      className="tab-pane text-muted"
                ...
                <div className="card-body">
                  ...
                  <div className="tab-content">
                    ...
                    >
                      ...
                      Restaurant weeks by the numbers. Will mexican food ever
                      rule the world? The 10 best thai restaurant youtube
                      videos. How restaurant weeks can make you sick.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card-body">
                  ...
                  <div className="tab-content mt-3">
                    ...
                    >
                      ...
                      beginner&apos;s guide to mission trips. If you read one
                      article about cultural notes read this one. Why you
                      shouldn&apos; eat vacation package in bed.
                    </div>
                    <div
                      className="tab-pane text-muted"
                      id="pill-flex-big"
                    ...
                    >
                      ...
                      think. How cultural solutions can help you predict the
                      future. How to cheat at dog friendly hotels and get away
                      with it. 17 problems with summer activities. How to cheat
                      at travel agents and get away with it. How not knowing
