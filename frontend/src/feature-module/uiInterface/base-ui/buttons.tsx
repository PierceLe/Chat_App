            ...
            <div className="col-xl-6">
              <div className="card">
                <div className="card-header">
                  ...
                  <p className="text-muted mb-0">
                    Use a classes <code>.btn-outline-**</code> to quickly create
                    a bordered buttons.
                  </p>
                </div>
                <div className="card-body">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="btn-list">
                    ...
                    <button
                      type="button"
                      className="btn btn-square btn-outline-dark"
                    >
                      Dark
                    </button>
                  </div>
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="btn-list">
                    <Link
                      className="btn btn-primary m-0 me-1"
                      to="#"
                      role="button"
                    >
                      Link
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="btn-list d-flex flex-wrap">
                    ...
                    <button
                      type="button"
                      className="btn btn-secondary btn-w-sm"
                    >
                      SM
                    </button>
                    ...
                    <button
                      type="button"
                      className="btn btn-info btn-w-lg me-0"
                    >
                      LG
                    </button>
                  </div>
            ...
            <div className="col-xl-6">
              <div className="card">
                <div className="card-header">
                  ...
                  <p className="text-muted mb-0">
                    Use a classes <code>.btn-icon</code> to quickly create a
                    bordered buttons.
                  </p>
                </div>
                <div className="card-body">
