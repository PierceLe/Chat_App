...
const DataTables = () => {
  ...
  const columns = [
    ...
    },
    {
      title: "Office",
      dataIndex: "office",
      sorter: (a: TableData, b: TableData) => a.office.length - b.office.length,
    },
    {
      title: "Age",
      dataIndex: "age",
      sorter: (a: TableData, b: TableData) => a.age.length - b.age.length,
    },
    {
      title: "Start date",
      dataIndex: "startDate",
    ...
    },
    {
      title: "Salary",
      dataIndex: "age",
      sorter: (a: TableData, b: TableData) => a.salary.length - b.salary.length,
    },
  ];
  return (
    <div>
