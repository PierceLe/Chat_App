                      ...
                      <tr>
                        ...
                        <td>
                          <button className="btn btn-sm btn-success btn-wave waves-effect waves-light">
                            <i className="feather icon-download align-middle me-2 d-inline-block" />
                            Download
                          </button>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <button className="btn btn-sm btn-danger btn-wave waves-effect waves-light">
                            <i className="feather icon-trash align-middle me-2 d-inline-block" />
                            Delete
                          </button>
                        </td>
                      </tr>
                  ...
                  <table className="table text-nowrap table-sm">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>29-April-2022</td>
                        <td>
                          <span className="badge bg-soft-danger">Pending</span>
                        </td>
                        <td>
                          <div className="hstack gap-2 fs-15">
                            <Link
                  ...
                  <table className="table text-nowrap table-hover">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            <div className="avatar avatar-sm me-2 avatar-rounded">
                              <ImageWithBasePath
                                src="assets/admin/img/profiles/profile-01.jpg"
                                alt="img"
                              />
                            </div>
                            <div>
                        ...
                        <td>
                          <span className="badge bg-soft-primary">Fashion</span>
                        </td>
                        <td>
                          <div className="avatar-list-stacked">
                            ...
                            <span className="avatar avatar-sm avatar-rounded">
                              <ImageWithBasePath
                                src="assets/admin/img/profiles/profile-08.jpg"
                                alt="img"
                              />
                            </span>
                            <span className="avatar avatar-sm avatar-rounded">
                      ...
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            <div className="avatar avatar-sm me-2 avatar-rounded">
                              <ImageWithBasePath
                                src="assets/admin/img/profiles/profile-03.jpg"
                                alt="img"
                              />
                            </div>
                            <div>
                        ...
                        <td>
                          <div className="avatar-list-stacked">
                            <span className="avatar avatar-sm avatar-rounded">
                              <ImageWithBasePath
                                src="assets/admin/img/profiles/profile-04.jpg"
                                alt="img"
                              />
                            </span>
                            <span className="avatar avatar-sm avatar-rounded">
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="avatar-list-stacked">
                            ...
                            <span className="avatar avatar-sm avatar-rounded">
                              <ImageWithBasePath
                                src="assets/admin/img/profiles/profile-10.jpg"
                                alt="img"
                              />
                            </span>
                            <span className="avatar avatar-sm avatar-rounded">
                              <ImageWithBasePath
                                src="assets/admin/img/profiles/profile-09.jpg"
                                alt="img"
                              />
                            </span>
                            <Link
                  ...
                  <table className="table text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <span className="badge bg-soft-success">Manager</span>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>Recruiter</td>
                        <td>
                          <span className="badge bg-soft-danger">Employee</span>
                        </td>
