...
const Calls = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a: any, b: any) =>
        a.Total_Incoming_Call.length - b.Total_Incoming_Call.length,
    },
    {
      title: "Total Outgoing Call",
      dataIndex: "Total_Outgoing_Call",
      sorter: (a: any, b: any) =>
        a.Total_Outgoing_Call.length - b.Total_Outgoing_Call.length,
    },
    {
      title: "Total Missed Call",
      dataIndex: "Total_Missed_Call",
      sorter: (a: any, b: any) =>
        a.Total_Missed_Call.length - b.Total_Missed_Call.length,
    },
    {
      title: "Action",
      dataIndex: "reason",
        ...
        <div className="content container-fluid">
          ...
          <div className="d-md-flex d-block align-items-center justify-content-between mb-4">
            <div className="my-auto">
              <h4 className="page-title mb-1">Calls</h4>
              <nav>
