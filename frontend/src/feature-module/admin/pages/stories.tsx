...
import { stories } from "../core/data/json/stories";
...
const Stories = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a: any, b: any) =>
        a.Email_Address.length - b.Email_Address.length,
    },
    {
      title: "Stories Date",
      dataIndex: "Stories_Date",
      sorter: (a: any, b: any) => a.Stories_Date.length - b.Stories_Date.length,
    },
    {
      title: "Action",
      dataIndex: "reason",
        ...
        <div className="content container-fluid">
          ...
          <div className="d-md-flex d-block align-items-center justify-content-between mb-4">
            <div className="my-auto">
              <h4 className="page-title mb-1">Stories</h4>
              <nav>
